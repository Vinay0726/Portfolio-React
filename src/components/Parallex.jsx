...
function Parallax() {
  ...
  return (
    <div
      ref={ref}
      className="w-full mt-40 md:mt-0 lg:mt-5   h-screen relative overflow-hidden"
    >
      <motion.h1
        className="text-7xl left-[22%] top-[35%]  md:text-9xl font-semibold md:top-[30%] lg:top-[20%] absolute   md:left-[22%] lg:left-[35%]"
        style={{ y: yText }}
