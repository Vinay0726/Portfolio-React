...
function SlideBar() {
  ...
  return (
    ...
    >
      <motion.div
        variants={varients}
        className="bg-white w-[70%] lg:w-[30%] h-[70%]  md:w-[400px] md:h-full  fixed top-0 left-0 cursor-pointer "
      >
      ...
      <button
        ...
        className=" w-[55px] h-[55px] left-[10px] top-[20px] flex justify-center items-center bg-white rounded-[50%] fixed md:left-[15px] md:top-[5px]"
      >
        {open ? (
