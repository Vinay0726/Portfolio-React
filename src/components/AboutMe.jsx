...
function AboutMe({close, setClose}) {
  ...
  return (
    <div
      className={` h-[90%] w-[75%]  flex top-10 left-52 shadow-2xl bg-transparent backdrop-blur-3xl absolute z-10 ${
        close ? "hidden" : "block"
      }`}
    >
      <AiOutlineClose
      ...
      <div className="w-[60%] h-full">
        <div className="ml-40 h-[55%] w-full flex flex-col justify-center items-start gap-5">
        ...
        <div className=" h-[45%] w-full">
          <h1 className="ml-40 text-blue-600 text-2xl font-bold">FULL STACK</h1>
          <div className="flex gap-5 w-[60%] ml-40 mt-10">
      ...
      <div className="w-[40%] h-full flex justify-center items-center border-gray-60000">
